...
- [x] Minimal Viewport (center/zoom/size + tile-local→screen). PARTIAL:
      no overzoom, no visible-tile enumerator.
...
- [x] Minimal framework-independent Viewport (center lat/lon, zoom,
      screen size + tile_size_px). PARTIAL.
